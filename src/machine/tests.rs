...
fn test_nestest() {
    ...
    assert_eq!(cnt, 4367);
    assert_eq!(exe.last_exec_inst.opcode, Opcode::CLC);
    assert_eq!(exe.register.y, 0xaa);
    ...
    cnt += 1;
    assert_eq!(cnt, 8990);
    assert_eq!(exe.last_exec_inst.opcode, Opcode::RTS);
